...
test('Flapper#handleTend changes the highestBidder and amount', () => {
  ...
  let auction = Auctions.loadOrCreateAuction(id + '-0', event)
  ...
  assert.fieldEquals('Auction', auction.id, 'bidAmount', bid)
