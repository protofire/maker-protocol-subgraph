...
test(
  "Spot#handleFile creates SpotParLog when signature is 0x29ae8114 and what is par", () => {
...
test(
  "Spot#handleFile creates CollateralPrice when signature is 0xebecb39d and what is pip", () => {
